        ...
        <div class="grid grid-cols-6 gap-4 w-full">
            ...
            <div class="col-span-2">
                <div class="flex flex-col">
                    ...
                    <p class="text-gray-800 mb-0 text-right mb-2 font-semibold">Cash on Delivery</p>
                    <p class="text-gray-600 text-xs text-right  tracking-wider">Discount Amount</p>
                    <p class="text-gray-800 mb-0 text-right mb-4 font-semibold">0 BDT</p>
                </div>
            </div>
            <div class="col-span-2">
                <div class="flex flex-col">
                    <p class="text-gray-600 text-xs text-right tracking-wider">Total Amount</p>
                    <p class="text-gray-800 mb-0 text-2xl font-medium text-right">1,510 BDT</p>
                </div>
            </div>
        </div>
    </section>

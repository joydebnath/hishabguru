<template>
    <div class="max-w-6xl m-auto w-1/2 py-6">
        <nav class="level box shadow">
            ...
            <div class="level-item has-text-centered">
                <div>
                    ...
                    <p class="title flex flex-row">
                        <b-skeleton width="60px" height="10" :animated="false"/>
                    </p>
                </div>
            </div>
            <div class="level-item has-text-centered">
            ...
            <div class="level-item has-text-centered">
                <div>
                    ...
                    <p class="title flex flex-row text-red-600">
                        <b-skeleton width="60px" height="10" :animated="false"/>
                    </p>
                </div>
            </div>
        ...
        <section>
            <svg class="m-auto" xmlns="http://www.w3.org/2000/svg" width="800" height="600"

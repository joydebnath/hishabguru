<template>
    <b-modal
        ...
        :can-cancel="['x']"
    >
        <div class="card py-3" style="width: 400px">
            <div class="flex flex-col justify-content-between">
                <div class="flex flex-row justify-content-center">
                    <svg class="h-32 w-32"
                         xmlns="http://www.w3.org/2000/svg" width="733.86247" height="702.19479"
                        ...
                        <path
                            ...
                            transform="translate(-233.06876 -98.90261)" fill="#e6e6e6"/>
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-233.06876 -98.90261)" fill="#3f3d56"/>
                        <path
                            ...
                            transform="translate(-233.06876 -98.90261)" fill="#41b7fc"/>
                        <circle cx="366.50903" cy="197.56776" r="5.06425" fill="#41b7fc"/>
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-233.06876 -98.90261)" fill="#f2f2f2"/>
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-233.06876 -98.90261)" fill="#f2f2f2"/>
                        <rect x="373.06222" y="262.72169" width="182.53915" height="175.81992" rx="3.35962"
                              fill="#fff"/>
                        <path
                    ...
                    <p class="text-grey-800 flex flex-row align-items-center w-32">
                        <span class="mr-1 text-sm">Downloading</span>
                        <b-skeleton width="50%" height="7px" :animated="true"/>
                    </p>
                </div>
            </div>
        </div>

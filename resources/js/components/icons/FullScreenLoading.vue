<template functional>
    <svg id="star" xmlns="http://www.w3.org/2000/svg" width="64px" height="64px" viewBox="0 0 128 128"
         xml:space="preserve">
                <rect x="0" y="0" width="100%" height="100%" fill="#FFFFFF"/>
        <g><path d="M64 0L40.08 21.9a10.98 10.98 0 0 0-5.05 8.75C34.37 44.85 64 60.63 64 60.63V0z" fill="#b6b6b6" fill-opacity="0.29"/>
            <path d="M128 64l-21.88-23.9a10.97 10.97 0 0 0-8.75-5.05C83.17 34.4 67.4 64 67.4 64H128z"
                  fill="#9e9e9e" fill-opacity="0.38"/>
            <path
            ...
            <path
                ...
                fill="#5a5a5a" fill-opacity="0.65"/>
            <path d="M0 64l21.88 23.9a10.97 10.97 0 0 0 8.75 5.05C44.83 93.6 60.6 64 60.6 64H0z" fill="#6b6b6b"
                  fill-opacity="0.58"/>
            <path

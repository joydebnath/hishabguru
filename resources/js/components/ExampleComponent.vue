    ...
    <div class="max-w-6xl m-auto w-1/2 py-6">
        <nav class="level box shadow">
            <span class="text-gray-700 flex flex-col align-items-center">
                <small class="mb-0">Statistics</small> <span class="text-uppercase tracking-wider">October</span>
            </span>
            <div class="level-item has-text-centered">
                <div>
                    <p class="heading text-green-700">Incomes</p>
                    <p class="title ">34,560</p>
                </div>
            </div>
            <div class="level-item has-text-centered">
                <div>
                    <p class="heading text-orange-600">Expenses</p>
                    <p class="title">1,890</p>
                </div>
            </div>
            <div class="level-item has-text-centered">
                <div>
                    <p class="heading text-red-700">Bills to pay</p>
                    <p class="title">6,650</p>
                </div>
            </div>
            <div class="level-item has-text-centered">
                <div>
                    <p class="heading text-gray-800">Customer Due</p>
                    <p class="title text-red-600">15,000</p>
                </div>
            </div>
        </nav>
        <section >
            <svg class="m-auto" xmlns="http://www.w3.org/2000/svg"
                 width="800" height="600" viewBox="0 0 1027.4958 696.05876"><title>experience design</title>
                <circle cx="696.2479" cy="355.70168" r="76.7521" fill="#41b7fc" opacity="0.4"/>
                ...
                <path
                    ...
                    transform="translate(-86.2521 -101.97062)" fill="#f2f2f2"/>
                <path
                ...
                <path d="M682.11649,318.87255,624.2521,232.92193s87.63109,30.59259,77.68592,85.95062Z"
                      transform="translate(-86.2521 -101.97062)" fill="#3f3d56"/>
                <path d="M684.38771,318.87255l57.86439-85.95062s-87.63109,30.59259-77.68591,85.95062Z"
                      transform="translate(-86.2521 -101.97062)" fill="#41b7fc"/>
                <path d="M784.7521,797.87255h-429v-640h429Zm-427-2h425v-636h-425Z"
                      transform="translate(-86.2521 -101.97062)" fill="#2f2e41"/>
                <rect x="271" y="71.08308" width="427" height="2" fill="#2f2e41"/>
                <circle cx="282" cy="63.90193" r="4" fill="#41b7fc"/>
                <circle cx="293" cy="63.90193" r="4" fill="#41b7fc"/>
                <circle cx="304" cy="63.90193" r="4" fill="#41b7fc"/>
                <rect x="286" y="84.90193" width="18" height="10" fill="#41b7fc"/>
                <rect x="286" y="163.90193" width="88" height="10" fill="#41b7fc"/>
                <rect x="685.2521" y="186.87255" width="88" height="10"
                      transform="translate(1372.2521 281.77448) rotate(-180)" fill="#f2f2f2"/>
                ...
                <rect x="410" y="611.90193" width="88" height="10" fill="#41b7fc"/>
                ...
                <rect x="312.5" y="271.90193" width="348" height="2" fill="#41b7fc" opacity="0.3"/>
                <rect x="312" y="306.90193" width="74" height="66" fill="#41b7fc" opacity="0.3"/>
                ...
                <path
                    ...
                    transform="translate(-86.2521 -101.97062)" fill="#41b7fc"/>
                <circle cx="489.20618" cy="333.79786" r="4.88134" fill="#41b7fc"/>
                <path
                ...
                <path
                    ...
                    transform="translate(-86.2521 -101.97062)" fill="#41b7fc"/>
                <circle cx="629.20618" cy="333.79786" r="4.88134" fill="#41b7fc"/>
                <path
                    ...
                    transform="translate(-86.2521 -101.97062)" fill="#41b7fc"/>
                <rect x="286" y="498.90193" width="88" height="10" fill="#41b7fc"/>
                ...
                <circle cx="611.7521" cy="512.70168" r="31.2479" fill="#41b7fc" opacity="0.4"/>
                <circle cx="553.92017" cy="527.62605" r="21.92017" fill="#41b7fc" opacity="0.4"/>
                ...
                <path
                    ...
                    transform="translate(-86.2521 -101.97062)" fill="#41b7fc"/>
                <ellipse cx="313.52848" cy="596.95692" rx="39.5" ry="12.40027"
                         transform="translate(-446.20984 527.75787) rotate(-65.07683)" fill="#2f2e41"/>
                <ellipse cx="168.52848" cy="620.95692" rx="12.40027" ry="39.5"
                         transform="translate(-357.17251 49.01394) rotate(-27.89329)" fill="#2f2e41"/>
                <ellipse cx="906.25518" cy="625.62283" rx="12.40027" ry="39.5"
                         transform="translate(-250.61562 265.81898) rotate(-21.07832)" fill="#2f2e41"/>
                <circle cx="893.18955" cy="583.10381" r="79" fill="#2f2e41"/>
                <rect x="991.67544" y="747.00687" width="24" height="43"
                      transform="matrix(-1, 0.0028, -0.0028, -1, 1923.24743, 1432.22882)" fill="#2f2e41"/>
                <rect x="943.67563" y="747.14132" width="24" height="43"
                      transform="translate(1827.24837 1432.63217) rotate(179.83951)" fill="#2f2e41"/>
                <ellipse cx="995.7371" cy="790.5292" rx="20" ry="7.5"
                         transform="translate(-88.46246 -99.17847) rotate(-0.16049)" fill="#2f2e41"/>
                <ellipse cx="947.73448" cy="789.66365" rx="20" ry="7.5"
                         transform="translate(-88.46023 -99.31292) rotate(-0.16049)" fill="#2f2e41"/>
                ...
                <path
                    ...
                    transform="translate(-86.2521 -101.97062)" fill="#41b7fc"/>
                <ellipse cx="1068.31896" cy="648.16898" rx="39.5" ry="12.40027"
                         transform="translate(-261.30169 421.84772) rotate(-25.53475)" fill="#2f2e41"/>
                <path
                    ...
                    transform="translate(-86.2521 -101.97062)" fill="#fff"/>
                <circle cx="917.2479" cy="468.70168" r="110.2479" fill="#41b7fc" opacity="0.4"/>
                <circle cx="190.40483" cy="348.59022" r="79" fill="#2f2e41"/>
                <rect x="226.16663" y="506.95016" width="24" height="43"
                      transform="translate(11.69174 -135.94422) rotate(10.26106)" fill="#2f2e41"/>
                <rect x="273.39893" y="515.50057" width="24" height="43"
                      transform="translate(13.97028 -144.22112) rotate(10.26106)" fill="#2f2e41"/>
                <ellipse cx="285.68749" cy="563.4754" rx="7.5" ry="20"
                         transform="translate(-415.18867 315.35713) rotate(-49.73894)" fill="#2f2e41"/>
                <ellipse cx="239.4392" cy="555.10313" rx="7.5" ry="20"
                         transform="translate(-425.15907 277.10318) rotate(-49.73894)" fill="#2f2e41"/>
                ...
                <path
                    ...
                    transform="translate(-86.2521 -101.97062)" fill="#41b7fc"/>
                <ellipse cx="349.6025" cy="436.16834" rx="39.5" ry="12.40027"
                         transform="translate(-174.86437 -12.8362) rotate(-12.9101)" fill="#2f2e41"/>
                <ellipse cx="194.52848" cy="461.95692" rx="39.5" ry="12.40027"
                         transform="translate(-184.5461 -46.83125) rotate(-12.9101)" fill="#2f2e41"/>
                <path
                    ...
                    transform="translate(-86.2521 -101.97062)" fill="#fff"/>
                <rect x="380.7521" y="374.37255" width="74" height="66"
                      transform="translate(48.33035 -204.77859) rotate(16.68876)" fill="#3f3d56"/>
                <path
                    ...
                    transform="translate(-86.2521 -101.97062)" fill="#41b7fc"/>
                <circle cx="338.23982" cy="301.05004" r="4.88134" fill="#41b7fc"/>
                <path

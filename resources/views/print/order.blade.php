...
<table class="table mt-5">
    ...
    <tr>
        ...
        <td class="border-0 pl-0">
            ...
            <p class="mb-1">{{ trans('invoices::invoice.pay_until') }}: <strong style="color: #403f3f">{{ $invoice->getPayUntilDate() }}</strong></p>
        </td>
    </tr>
    </tbody>
</table>
...
<p style="font-size: 1.05em;">
    {{ trans('invoices::invoice.amount_in_words') }}: <span class="text-uppercase">{{ $invoice->getTotalAmountInWords() }}</span>
</p>
